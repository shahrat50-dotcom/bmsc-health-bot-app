    ...
    <div className="flex h-screen w-full justify-center bg-[#F0F9FF] text-slate-900 font-sans">
      <div className="relative flex h-full w-full max-w-md flex-col overflow-hidden sm:border-x sm:border-sky-100 sm:shadow-2xl">
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <nav className="bg-white rounded-[2.5rem] p-3 flex justify-between items-center shadow-2xl shadow-sky-900/20 border border-white overflow-x-auto">
            ...
            <NavItem to="/app/profile" icon={(<svg className="w-5 h-5 mx-auto flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>)} label="Profile" />
          </nav>
        </div>
      </div>
    </div>
